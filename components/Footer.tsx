  ...
  return (
    <footer className='w-full pt-10 py-8' id="contact">
        ...
        <div className='flex lg:mt-40 mt-40 md:flex-row flex-col justify-between items-center'>
            <p className="md:text-base py-6 text-sm md:font-normal font-light">Copyright&copy; 2024 <span className="text-purple">Sixtusdev</span> | All rights reserved | terms & conditions.</p>
